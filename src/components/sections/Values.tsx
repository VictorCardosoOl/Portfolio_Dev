  ...
  return (
    ...
    >
      <div className="p-6 md:p-10 3xl:p-24 4xl:p-32 flex flex-col min-h-[40vh] md:min-h-[80vh]">
        ...
        <div className="flex-grow flex items-center justify-center p-6 md:p-10 3xl:p-24">
      ...
      <div className="p-6 md:p-10 3xl:p-24 4xl:p-32 flex flex-col min-h-[40vh] md:min-h-[80vh]">
        ...
        <div className="flex-grow flex flex-col justify-center items-start mt-8 md:mt-0">
          <ul className="values-list space-y-6 md:space-y-8 w-full max-w-xl" aria-label="Core Values List">
            {CORE_VALUES.map((item, index) => (
              <li 
                key={item.title}
                className="value-item flex flex-col md:flex-row gap-4 md:gap-8 border-b border-charcoal/10 pb-6 group"
              >
