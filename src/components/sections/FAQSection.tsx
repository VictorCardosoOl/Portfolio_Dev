  ...
  return (
    ...
    >
      ...
      <div className="container-fluid py-12 md:py-16">
        ...
        <div className="faq-header flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 md:mb-12">
          <div>
            <div className="overflow-hidden mb-4">
              <span className="faq-header-line block text-[10px] uppercase tracking-[0.3em] font-bold text-cream/40">
                05 / Dúvidas Frequentes
              </span>
            </div>
            <div className="overflow-hidden">
              <h2 className="faq-header-line text-fluid-h2 font-serif font-light leading-none tracking-tighter uppercase text-cream">
                Perguntas
              </h2>
            </div>
          </div>
        ...
        {/* ── LISTA ── */}
        <ul className="faq-list divide-y divide-cream/10">
          {FAQ_ITEMS.map((item, i) => {
            ...
            return (
              <li key={item.id} className="faq-row">
                ...
                >
                  ...
                  <span
                    className={`flex-1 text-2xl md:text-3xl lg:text-4xl font-serif tracking-tight transition-colors duration-300 ${
                      isOpen ? 'text-cream/50' : 'text-cream'
                    }`}
                  >
                    {item.question}
                  </span>
                  ...
                  {/* Toggle icon */}
                  <span
                    className={`shrink-0 ml-2 text-cream/40 transition-transform duration-500 ${
                ...
                >
                  <p className="pl-14 md:pl-20 pb-8 text-sm md:text-base font-light text-cream/60 leading-relaxed max-w-2xl">
                    {item.answer}
                  </p>
                </div>
              </li>
