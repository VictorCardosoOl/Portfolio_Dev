        ...
        <article className="w-full max-w-6xl mx-auto px-6 py-32 md:py-48 flex flex-col gap-32">
          ...
          {(project.liveUrl || project.repoUrl) && (
            <section className="flex gap-6 mt-24 justify-center">
              ...
              {project.repoUrl && (
                <MagneticButton>
                  <a href={project.repoUrl} target="_blank" rel="noopener noreferrer" className="px-10 py-5 border border-[#1a1a1a] text-[#1a1a1a] rounded-full text-xs font-bold tracking-widest uppercase hover:bg-[#1a1a1a]/5 transition-colors font-sans flex items-center gap-2">
